<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KaoHe.aspx.cs" Inherits="HRNew_KaoHe" %>
<html>
	<head>
		<title>政务OA</title>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;人力资源&nbsp;>>&nbsp;考核管理
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:BoundField DataField="KaoHeJieLun" HeaderText="考核结论" ></asp:BoundField>     
</Columns>
