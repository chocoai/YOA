<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KaoHeXM.aspx.cs" Inherits="HRNew_KaoHeXM" %>
<html>
	<head>
		<title>政务OA</title>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;人力资源&nbsp;>>&nbsp;考核项目
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="考核项目"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "KaoHeXMView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "XiangMuName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
					<asp:BoundField DataField="FenZhi" HeaderText="所占分值" ></asp:BoundField>     
					<asp:BoundField DataField="KaoHeYiJu" HeaderText="考核依据" ></asp:BoundField>    
