<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkFlowDesign.aspx.cs" Inherits="WorkFlow_WorkFlowDesign" %>
<html>
	<head>
		<title>政务OA</title>
...
<body>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="../images/Button/BtnAdd.jpg" ImageAlign="AbsMiddle" OnClick="ImageButton1_Click" />&nbsp;<asp:ImageButton
                        ID="ImageButton5" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnModify.jpg"
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        <asp:TemplateField>
                         ...
                         <asp:BoundField DataField="JieDianSerils" HeaderText="节点序号" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="JieDianName" HeaderText="节点名称" >
                        </asp:BoundField> 
                        <asp:BoundField DataField="JieDianAddr" HeaderText="节点位置" >
                        </asp:BoundField>     
                        <asp:BoundField DataField="NextJieDianSerils" HeaderText="下一节点" >
                        </asp:BoundField>
                    </Columns>
        ...
        <IFRAME name="ShowForm" frameBorder="0" marginHeight="0" marginWidth="0" Height="440px" width="100%" src="ShowWorkFlow.aspx?ID=<%=Request.QueryString["ID"].ToString() %>" border="0"></IFRAME>
            </asp:Panel>
    </form>
</body>
</html>