<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WorkFlowManage.aspx.cs" Inherits="WorkFlow_WorkFlowManage" %>
...
<head>
    ...
    <script type="text/javascript">
        var dialog;
        function selectFlowConditionCallback(returndata) {
                ...
                <tr>
                    <td colspan="2" class="filter_box">
                        <div class="form-group">
                            流程名称：<asp:TextBox ID="TextBox2" CssClass="form-control" runat="server" Width="100px"></asp:TextBox>
                            <a onclick="openDialog('../Main/SelectCondition.aspx?TableName=ERPWorkFlow&LieName=WorkFlowName&callbackFun=selectFlowConditionCallback',350,400);"><span class="glyphicon glyphicon-filter glyphicon-size-md"></span></a>
                            所属表单：<asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" Width="100px"></asp:TextBox>
                            <a onclick="openDialog('../Main/SelectCondition.aspx?TableName=ERPWorkFlow&LieName=FormName&callbackFun=selectFormConditionCallback',350,400);"><span class="glyphicon glyphicon-filter glyphicon-size-md"></span></a>
                            ...
                            <asp:TemplateField HeaderText="流程名称">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink1" runat="server"
                                        NavigateUrl='<%# "WorkFlowView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "WorkFlowName")%></asp:HyperLink>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Left" />
                            </asp:TemplateField>
                            <asp:BoundField DataField="FormName" HeaderText="所属表单"></asp:BoundField>
                            <asp:BoundField DataField="GuiDangType" HeaderText="归档类别"></asp:BoundField>
                            <asp:BoundField DataField="JianJie" HeaderText="流程简介"></asp:BoundField>
                            <asp:TemplateField HeaderText="流程定义">
                                <ItemTemplate>
                                    <asp:HyperLink ID="HyperLink22" runat="server" NavigateUrl='<%# "WorkFlowDesign.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID") %>' ForeColor="Red">【流程定义】</asp:HyperLink>
                                </ItemTemplate>
