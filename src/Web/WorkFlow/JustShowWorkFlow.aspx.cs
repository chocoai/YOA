...
{    
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            SqlDataReader NewReader = ZWL.DBUtility.DbHelperSQL.GetDataReader(SQL_GetList);
            int i1 = 20;
