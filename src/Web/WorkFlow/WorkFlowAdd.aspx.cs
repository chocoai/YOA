...
public partial class WorkFlow_WorkFlowAdd : System.Web.UI.Page
{
    ...
    {        
        //判断工作流名称是否唯一性
        if (ZWL.Common.PublicMethod.IFExists("WorkFlowName", "ERPWorkFlow", 0, this.TextBox1.Text) == false)
        {
            ZWL.Common.MessageBox.Show(this, "该工作流名称已经存在！");
            return;
        }

        ZWL.BLL.ERPWorkFlow Model = new ZWL.BLL.ERPWorkFlow();
        ...
        ZWL.Common.MessageBox.ShowAndRedirect(this, "工作流程添加成功！", "WorkFlowManage.aspx");
    }
}