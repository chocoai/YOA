<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FormAdd.aspx.cs" Inherits="WorkFlow_FormAdd" %>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectyinzhang(imgidstr) {
            openDialog('../Main/SelectYinZhang.aspx?callbackFun=selectYinZhangCallback', 300, 500);
        }
        ...
        <div>
            ...
            <table style="width: 100%" class="table" >
                ...
                <tr>
                    ...
                    <td >
                        <asp:DropDownList CssClass="form-control" ID="DropDownList3" runat="server" Width="350px">
                        </asp:DropDownList></td>
                </tr>
                <tr>
                    <td align="right" style="width: 170px;">使用范围：</td>
                    <td >
                        <asp:TextBox CssClass="form-control" ID="TextBox3" runat="server" Width="350px"></asp:TextBox>
                ...
                <tr>
                    ...
                    <td >
                        <asp:DropDownList CssClass="form-control" ID="DropDownList1" runat="server" Width="194px">
                        </asp:DropDownList>
                        ...
                        类型：<asp:DropDownList width="100" CssClass="form-control" ID="DropDownList2" runat="server">
