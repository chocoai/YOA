...
public partial class WorkFlow_WorkAdd : System.Web.UI.Page
{
    ...
    {
        this.Label1.Text = ZWL.DBUtility.DbHelperSQL.GetSHSL("select top 1 ContentStr from ERPForm where FormName='" + FormName + "'");
        //替换各种宏控件
        this.Label1.Text = this.Label1.Text.Replace("宏控件-用户部门", ZWL.Common.PublicMethod.GetSessionValue("Department"));
        this.Label1.Text = this.Label1.Text.Replace("宏控件-用户姓名", ZWL.Common.PublicMethod.GetSessionValue("UserName"));
        this.Label1.Text = this.Label1.Text.Replace("宏控件-用户角色", ZWL.Common.PublicMethod.GetSessionValue("JiaoSe"));
        this.Label1.Text = this.Label1.Text.Replace("宏控件-用户职位", ZWL.Common.PublicMethod.GetSessionValue("ZhiWei"));
