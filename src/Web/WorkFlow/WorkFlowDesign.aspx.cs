...
public partial class WorkFlow_WorkFlowDesign : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            DataBindToGridview();
            this.Label1.Text = "流程名称："+ZWL.DBUtility.DbHelperSQL.GetSHSL("select top 1 WorkFlowName from ERPWorkFlow where ID="+Request.QueryString["ID"].ToString());  
        }
    }
    ...
    protected void ImageButton3_Click(object sender, ImageClickEventArgs e)
    {
        ...
        if (ZWL.DBUtility.DbHelperSQL.ExecuteSQL("delete from ERPWorkFlowJieDian where ID in (" + IDlist + ")") == -1)
        {
    ...
    protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
    {
        ...
        ZWL.Common.DataToExcel.GridViewToExcel(ZWL.DBUtility.DbHelperSQL.GetDataSet("select JieDianSerils,JieDianName,JieDianAddr,NextJieDianSerils from ERPWorkFlowJieDian where ID in (" + IDList + ") order by JieDianSerils asc"), MyTable, "Excel报表");
    }
