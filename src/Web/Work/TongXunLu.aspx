                ...
                <td>
                    <asp:GridView ID="GVData" CssClass="table table-striped table-hover" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DanWeiMingCheng" HeaderText="单位名称"></asp:BoundField>
                            <asp:BoundField DataField="DanWieDianHua" HeaderText="单位电话"></asp:BoundField>
                            <asp:BoundField DataField="JiaTingDianHua" HeaderText="家庭电话"></asp:BoundField>
                            <asp:BoundField DataField="ShouJi" HeaderText="手机"></asp:BoundField>
