...
public partial class HR_ShenPi : System.Web.UI.Page
{
    ...
    public void DataBindToGridview()
    {
        ...
        GVData.DataSource = MyModel.GetList("BackInfo Like '%" + this.TextBox1.Text + "%' and ShenPiRen='" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "' and TypeName='" + Request.QueryString["TypeName"].ToString() + "' order by ID desc");
        GVData.DataBind();
