<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SelectUser1.aspx.cs" Inherits="SelectCondition" %>
		...
		<form id="Form1" method="post" runat="server">
			<table border="0" width="100%" cellspacing="0" cellpadding="0" height="100%" bordercolorlight="#c0c0c0" bordercolordark="#ffffff">
			    ...
			    <td valign="top" style="text-align: center">				  
                    <table  border="0" cellspacing="0" cellpadding="0" style="width: 318px; height: 49px">
                        <tr>
                            <td colspan="2" style="height: 31px; text-align: left">
                                部&nbsp; 门：<asp:TextBox ID="TextBox2" runat="server" Height="20px"
                        ...
                        src="../images/Button/search.gif" />
                                角色：<asp:TextBox ID="TextBox3" runat="server" Height="20px" Width="85px"></asp:TextBox>
                    ...
                    用户名：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="85px"></asp:TextBox>&nbsp;
                                <asp:ImageButton
                        ID="ImageButton4" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/BtnSerch.jpg"
                        OnClick="ImageButton4_Click" />
                                <INPUT  TYPE="button"  VALUE="全部加入"  onclick="AllSelect();" style="width: 69px" class="BottonCss" id="Button2"></td>
                        </tr>
                    <tr>
                      ...
                      <tr>
                          <td colspan="2" style="height: 31px; text-align: center;">
                              已选：<asp:TextBox ID="TextBox4" runat="server" Width="175px"></asp:TextBox><INPUT  TYPE="button"  VALUE="加入"  onclick="AddSelect();" style="width: 49px" class="BottonCss" id="Button1"><INPUT  TYPE="button"  VALUE="确定"  onclick="sendFromChild();" style="width: 48px" class="BottonCss"></td>
                      </tr>                        
                    </table></td>
				</tr>
				<tr>
