...
public partial class OnlineCount : System.Web.UI.Page
{
    ...
    protected void CheckCaiGou()
    {
        ...
        DataSet MyDataSet = ZWL.DBUtility.DbHelperSQL.GetDataSet("select * from ERPBuyOrder where UserName='" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "' and TiXingDate='" + ToDayStr + "'");
    ...
    {
        string ToDayStr = DateTime.Now.Year.ToString() + "-" + DateTime.Now.Month.ToString() + "-" + DateTime.Now.Day.ToString();
        DataSet MyDataSet = ZWL.DBUtility.DbHelperSQL.GetDataSet("select * from ERPProject where UserName='" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "' and TiXingDate='" + ToDayStr + "'");
        for (int j = 0; j < MyDataSet.Tables[0].Rows.Count; j++)
        {
            ZWL.BLL.ERPLanEmail MyModel = new ZWL.BLL.ERPLanEmail();
    ...
    {
        string ToDayStr = DateTime.Now.Year.ToString() + "-" + DateTime.Now.Month.ToString() + "-" + DateTime.Now.Day.ToString();
        DataSet MyDataSet = ZWL.DBUtility.DbHelperSQL.GetDataSet("select * from ERPShouKuan where UserName='" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "' and ShouKuanDate='" + ToDayStr + "'");
        for (int j = 0; j < MyDataSet.Tables[0].Rows.Count; j++)
        {
            ZWL.BLL.ERPLanEmail MyModel = new ZWL.BLL.ERPLanEmail();
    ...
    { 
        DataSet MyDataSet = ZWL.DBUtility.DbHelperSQL.GetDataSet("select * from ERPAnPai where UserName='" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "' and datediff(minute,getdate(),TimeTiXing)<2 and datediff(minute,getdate(),TimeTiXing)>0");
        for (int j = 0; j < MyDataSet.Tables[0].Rows.Count; j++)
        {
            ZWL.BLL.ERPLanEmail MyModel = new ZWL.BLL.ERPLanEmail();
    ...
    {
        string ToDayStr = DateTime.Now.Year.ToString() + "-" + DateTime.Now.Month.ToString() + "-" + DateTime.Now.Day.ToString();
        DataSet MyDataSet = ZWL.DBUtility.DbHelperSQL.GetDataSet("select * from ERPLinkLog where UserName='" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "' and CusBakE='" + ToDayStr + "'");
        for (int j = 0; j < MyDataSet.Tables[0].Rows.Count; j++)
        {
            ZWL.BLL.ERPLanEmail MyModel = new ZWL.BLL.ERPLanEmail();
    ...
    {
        string ToDayStr = DateTime.Now.Year.ToString() + "-" + DateTime.Now.Month.ToString() + "-" + DateTime.Now.Day.ToString();
        DataSet MyDataSet = ZWL.DBUtility.DbHelperSQL.GetDataSet("select * from ERPSongYang where UserName='" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "' and CusBakE='" + ToDayStr + "'");
        for (int j = 0; j < MyDataSet.Tables[0].Rows.Count; j++)
        {
            ZWL.BLL.ERPLanEmail MyModel = new ZWL.BLL.ERPLanEmail();
    ...
    {
        string ToDayStr = DateTime.Now.Year.ToString() + "-" + DateTime.Now.Month.ToString() + "-" + DateTime.Now.Day.ToString();
        DataSet MyDataSet = ZWL.DBUtility.DbHelperSQL.GetDataSet("select * from ERPCustomInfo where UserName='" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "' and YuJiTiXing='" + ToDayStr + "'");
        for(int j=0;j<MyDataSet.Tables[0].Rows.Count;j++)
        {
            ZWL.BLL.ERPLanEmail MyModel = new ZWL.BLL.ERPLanEmail();
