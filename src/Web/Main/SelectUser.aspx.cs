...
{    
    ...
    public void DataBindToGridview()
    {
        ...
        ZWL.DBUtility.DbHelperSQL.BindItemList("select distinct UserName as SelectContent from ERPUser where Department like '%" + this.TextBox2.Text + "%' " + ConditionStr + " and JiaoSe like '%" + this.TextBox3.Text + "%'", this.ListBox1, "SelectContent", "SelectContent");
    }   
