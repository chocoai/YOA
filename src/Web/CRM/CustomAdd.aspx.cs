...
public partial class CRM_CustomAdd : System.Web.UI.Page
{
    ...
    {
        if (ZWL.Common.PublicMethod.IFExists("CustomName", "ERPCustomInfo", 0, this.txtCustomName.Text) == true)
        {
            ...
            ZWL.Common.MessageBox.ShowAndRedirect(this, "客户信息添加成功！", "MyCustom.aspx");
        }
        else
        {
