...
public partial class Meeting_MeetingSerch : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            ImageButton2.Visible = ZWL.Common.PublicMethod.StrIFIn("|F006e|", ZWL.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }
    ...
    public void DataBindToGridview()
    {
        ...
        DataSet ds = MyModel.GetList("MeetingTitle Like '%" + this.TextBox1.Text + "%' and HuiYiZhuChi Like '%" + this.TextBox2.Text + "%' order by ID desc");
