...
public partial class Meeting_MyMeeting : System.Web.UI.Page
{
    ...
    public void DataBindToGridview()
    {
        ...
        GVData.DataSource = MyModel.GetList("MeetingTitle Like '%" + this.TextBox1.Text + "%' and ','+ChuXiRen+',' like '%," + ZWL.Common.PublicMethod.GetSessionValue("UserName") + ",%' order by ID desc");
        GVData.DataBind();
