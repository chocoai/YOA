...
public partial class Meeting_MeetingDengJi : System.Web.UI.Page
{
    ...
    public void DataBindToGridview()
    {
        ...
        GVData.DataSource = MyModel.GetList("MeetingTitle Like '%" + this.TextBox1.Text + "%' and ZhuanXieRen='"+ZWL.Common.PublicMethod.GetSessionValue("UserName")+"' order by ID desc");
        GVData.DataBind();
