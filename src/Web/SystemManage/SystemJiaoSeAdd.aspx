    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
                ...
                <tr>
                    <td align="right" style="width: 170px; background-color: #cccccc; height: 25px;">角色名称：</td>
                ...
                <tr>
                    <td align="right" style="width: 170px; height: 25px; background-color: #cccccc">备注信息：</td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                        <asp:TextBox ID="TextBox2" runat="server" Width="350px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="right" style="width: 170px; height: 25px; background-color: #cccccc">权限配置：</td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                        <input id="CheckBoxAll" onclick="CheckAll()" type="checkbox" />全选</td>
                </tr>
                <tr>
                    <td colspan="2" style="padding-left: 5px; height: 25px; background-color: #ffffff; text-align: center" >
                        <asp:CheckBoxList ID="CheckBoxList1" runat="server" CssClass="table table-striped table-hover" RepeatColumns="8" RepeatDirection="Horizontal" Width="100%">
