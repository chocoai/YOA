...
window.open ("WorkFlowName_show_add_node_savaps.aspx?str="+str11+"", "_blank", "height=1, width=1,toolbar=no, menubar=no, scrollbars=no,resizable=yes,location=no, status=no")
...
LoadWindow("JieDianAdd.aspx?WorkFlowID="+str11+"");
}
...
{
    var str11=document.getElementById("FlowNumber").value;
	LoadWindow("JieDianModify.aspx?WorkFlowID="+str11+"&ID="+Process_ID);
}
...
function Del_Process(Process_ID)
{
   ...
   {   
    var str11=document.getElementById("FlowNumber").value;
	LoadWindow("JieDianDel.aspx?WorkFlowID="+str11+"&ID="+Process_ID);
	}
}
