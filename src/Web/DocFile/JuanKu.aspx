    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;档案文书&nbsp;>>&nbsp;卷库管理
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="卷库名称"> <ItemTemplate><img src="../images/filetype/dir.gif" style="vertical-align: middle" /> <asp:HyperLink ID="HyperLink1" runat="server"   NavigateUrl='<%# "JuanKuView.aspx?JuanKuName="+DataBinder.Eval(Container.DataItem, "JuanKuName")+"&ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "JuanKuName")%></asp:HyperLink> 
					
					
                        <asp:HyperLink ID="HyperLink2" runat="server"   NavigateUrl='<%# "DangAn.aspx?JuanKuName="+DataBinder.Eval(Container.DataItem, "JuanKuName") %>' ForeColor="Blue">[打开卷库]</asp:HyperLink>
