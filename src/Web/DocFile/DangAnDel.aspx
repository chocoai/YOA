            ...
            <tr>
                ...
                <td colspan="2" class="filter_box">
                   ...
                   查询:<asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" Width="100px"></asp:TextBox>
                    ...
                    <asp:Button ID="ImageButton3" Text="恢复"  runat="server" CssClass="btn btn-primary" OnClientClick="javascript:return CheckDel();" OnClick="ImageButton3_Click" />
                     <asp:Button ID="ImageButton1" Text="删除" CssClass="btn btn-danger" runat="server" OnClientClick="javascript:return CheckDel();" OnClick="ImageButton1_Click" />
