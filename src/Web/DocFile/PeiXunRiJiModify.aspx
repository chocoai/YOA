<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PeiXunRiJiModify.aspx.cs" Inherits="DocFile_PeiXunRiJiModify" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table style="width: 100%" class="table">
                ...
                <tr>
                    <td style="width: 170px;" align="right">日志主题：
                    </td>
                    <td>
                ...
                <tr>
                    <td style="width: 170px;" align="right">日志日期：
                    </td>
                    <td>
                ...
                <tr>
                    <td style="width: 170px;" align="right">日志内容：
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtTimeStr" CssClass="form-control" runat="server" Width="350px" Enabled="False"></asp:TextBox></td>
                </tr>
            </table>
        </div>
    </form>
