...
public partial class DocFile_PeiXunXiaoGuo : System.Web.UI.Page
{
	...
	protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
	{
		...
		ZWL.Common.DataToExcel.GridViewToExcel(ZWL.DBUtility.DbHelperSQL.GetDataSet("select  PeiXunName,FanKuiZhuTi,ZongTiJieLun,UserName,TimeStr  from ERPPeiXunXiaoGuo where ID in (" + IDList + ") order by ID desc"), MyTable, "Excel报表");
	}
