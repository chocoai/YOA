                ...
                <tr>
                    ...
                    <td >
                        <asp:TextBox ID="TextBox2" CssClass="form-control"  runat="server" Width="350px"></asp:TextBox>
                          <a onclick="openDialog('../Main/SelectUser.aspx?TableName=ERPUser&LieName=UserName&callbackFun=selectUserCallback',350,450);"><span class="glyphicon glyphicon-filter glyphicon-size-md"></span></a>
                    </td>
                </tr>
                <tr>
                    <td align="right" style="width: 170px;">附件：</td>
                    <td >
                        <asp:CheckBoxList ID="CheckBoxList1" CssClass="form-control"  runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
                        </asp:CheckBoxList>&nbsp;
                        <asp:Button ID="ImageButton3"  Text="删除" CssClass="btn btn-danger" runat="server"  CausesValidation="False" OnClick="ImageButton3_Click" /></td>
                </tr>
                <tr>
