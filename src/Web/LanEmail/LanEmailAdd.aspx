        ...
        <div>
            <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">&nbsp;<asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/Button/Submit.jpg"
            ...
            <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
                ...
                <tr>
                    <td align="right" style="width: 170px; background-color: #cccccc; height: 25px;">邮件主题：</td>
                ...
                <tr>
                    ...
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                        ...
                        <img class="HerCss" onclick="openDialog('../Main/SelectUser.aspx?TableName=ERPUser&LieName=UserName&callbackFun=selectUserCallback',350,450);"
                ...
                <tr>
                    <td align="right" style="width: 170px; height: 25px; background-color: #cccccc">邮件内容：</td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
