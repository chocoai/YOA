    ...
    <form id="form1" runat="server">
        <div>
                ...
                <tr>
                    <td colspan="2" class="filter_box">
                        <div class="form-group">
                            查询：<asp:TextBox ID="TextBox1" runat="server"  CssClass="form-control" Width="300px"></asp:TextBox>
                            <asp:Button ID="ImageButton4" runat="server" CssClass="btn btn-default" Text="查询"
                                OnClick="ImageButton4_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="ImageButton1" runat="server" OnClick="ImageButton1_Click" CssClass="btn btn-primary" Text="添加" />&nbsp;
                    <asp:Button ID="ImageButton2" runat="server" CssClass="btn btn-primary"
                        OnClick="ImageButton2_Click" OnClientClick="javascript:return CheckModify();" Text="发送" />&nbsp;
                    <asp:Button ID="ImageButton3" runat="server" CssClass="btn btn-danger" Text="删除" OnClientClick="javascript:return CheckDel();" OnClick="ImageButton3_Click" />&nbsp;
                    <asp:Button ID="ImageButton5" runat="server" CssClass="btn btn-info" Text="导出"
            ...
            <table style="width: 100%">
                <tr>
                    <td>
                        <asp:GridView CssClass="table table-striped table-hover" ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" OnRowDataBound="GVData_RowDataBound" PageSize="15"
