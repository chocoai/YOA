<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyPer.aspx.cs" Inherits="Personal_MyPer" %>
...
<body style="text-align: center">
    <form id="form1" runat="server">
        <div>
                ...
                <tr>
                    <td colspan="2" class="filter_box">
                        <div class="form-group">
                            <button onclick="PrintTable()" class="btn btn-primary" >打印</button>&nbsp;
            ...
            <table style="width: 100%"  class="table table-striped table-hover table-bordered"  border="0">
                <tr>
                    <td align="right" style="width: 170px;">用户名称：</td>
