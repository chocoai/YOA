                ...
                <tr>
                    <td colspan="2" class="filter_box">
                        <div class="form-group">
                            ...
                            <asp:Button Text="查询" CssClass="btn btn-default" ID="ImageButton4" runat="server"
                                OnClick="ImageButton4_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button Text="添加" CssClass="btn btn-primary" ID="ImageButton1" runat="server" OnClick="ImageButton1_Click" />&nbsp;
                    <asp:Button Text="恢复" CssClass="btn btn-warning" ID="ImageButton5" runat="server" OnClientClick="javascript:return CheckHuiFu();" OnClick="ImageButton5_Click" />&nbsp;
