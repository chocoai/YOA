                ...
                <tr>
                    <td colspan="2" class="filter_box">
                        <div class="form-group">
                            ...
                            <asp:Button
                                ID="ImageButton4" Text="查询" runat="server" CssClass="btn btn-default"
                                OnClick="ImageButton4_Click" />&nbsp;&nbsp; &nbsp;&nbsp;
                         <asp:Button ID="ImageButton3" Text="删除" CssClass="btn btn-danger" runat="server"
                             OnClick="ImageButton3_Click" OnClientClick="javascript:return CheckDel();" />
                            &nbsp;
                    <asp:Button Text="导出" ID="ImageButton2" CssClass="btn btn-info" runat="server" OnClick="ImageButton2_Click" />
                            &nbsp;
