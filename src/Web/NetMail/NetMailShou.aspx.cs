...
public partial class NetMail_NetMailShou : System.Web.UI.Page
{
    ...
    public void DataBindToGridview()
    {
        ...
        DataSet ds = MyLanEmail.GetList("EmailTitle like '%" + this.TextBox1.Text.Trim() + "%' and ToUser='" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "' and (EmailState='未读' or EmailState='已读')  order by ID desc");
