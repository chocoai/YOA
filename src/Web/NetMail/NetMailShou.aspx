                ...
                <tr>
                    <td colspan="2" class="filter_box">
                        <div class="form-group">
                            ...
                            <asp:Button CssClass="btn btn-default" Text="查询"
                                ID="ImageButton4" runat="server" OnClick="ImageButton4_Click"  />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:Button ID="ImageButton5" Text="收取新邮件"  runat="server" OnClick="ImageButton5_Click" CssClass="btn btn-info" />
                            &nbsp;
                    ...
                    <asp:Button ID="ImageButton3"   Text="删除" runat="server" OnClientClick="javascript:return CheckDel();" CssClass="btn btn-danger" OnClick="ImageButton3_Click" />
                            &nbsp;<asp:Button Text="导出"  ID="ImageButton2" runat="server" OnClick="ImageButton2_Click" CssClass="btn btn-info" />
                            &nbsp;
