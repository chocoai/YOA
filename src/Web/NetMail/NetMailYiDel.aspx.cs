...
public partial class NetMail_NetMailYiDel : System.Web.UI.Page
{
    ...
    public void DataBindToGridview()
    {
        ...
        DataSet ds = MyLanEmail.GetList("EmailTitle like '%" + this.TextBox1.Text.Trim() + "%' and ToUser='" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "' and EmailState='删除' order by ID desc");
