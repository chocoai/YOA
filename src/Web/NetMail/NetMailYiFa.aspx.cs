...
public partial class NetMail_NetMailYiFa : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            //设定按钮权限
            ImageButton3.Visible = ZWL.Common.PublicMethod.StrIFIn("|007d|", ZWL.Common.PublicMethod.GetSessionValue("QuanXian"));
            ImageButton2.Visible = ZWL.Common.PublicMethod.StrIFIn("|007e|", ZWL.Common.PublicMethod.GetSessionValue("QuanXian"));
        }
    }
