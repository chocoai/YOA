<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BookJieHuanOK.aspx.cs" Inherits="Office_BookJieHuan" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;图书管理&nbsp;>>&nbsp;借还管理
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    查询：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="60px"></asp:TextBox><asp:ImageButton
                        ...
                        OnClick="ImageButton4_Click" />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;<asp:ImageButton ID="ImageButton1"
                            runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/ShenPiOK1.jpg"
                            OnClick="ImageButton1_Click" OnClientClick="javascript:return CheckDel1();" /><asp:ImageButton
                                ID="ImageButton5" runat="server" ImageAlign="AbsMiddle" ImageUrl="../images/Button/ShenPiNo1.jpg"
