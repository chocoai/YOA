    ...
    <form id="form1" runat="server">
        <div>
            ...
            <table style="width: 100%" bgcolor="#999999" border="0" cellpadding="2" cellspacing="1">
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #cccccc" align="right">资产编号：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #cccccc" align="right">资产类别：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #cccccc" align="right">所属部门：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #cccccc" align="right">资产原值：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #cccccc" align="right">资产残值：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #cccccc" align="right">折旧年限：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #cccccc" align="right">资产性质：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #cccccc" align="right">启用时间：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #cccccc" align="right">保管人：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #cccccc" align="right">录入人：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                ...
                <tr>
                    <td style="width: 170px; height: 25px; background-color: #cccccc" align="right">录入时间：
                    </td>
                    <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
