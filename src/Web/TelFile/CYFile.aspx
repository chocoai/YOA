<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CYFile.aspx.cs" Inherits="TelFile_CYFile" %>
                ...
                <tr>
                    <td colspan="2" class="filter_box">
                        <div class="form-group">
                            查询：<asp:TextBox ID="TextBox1" runat="server" CssClass="form-control" Width="100px"></asp:TextBox>
                    ...
                    <asp:GridView ID="GVData" runat="server" CssClass="table table-striped table-hover" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="文件夹名称">
                                <ItemTemplate>
                                    <img src="../images/filetype/dir.gif" />
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "SendFile.aspx?DicID="+ DataBinder.Eval(Container.DataItem, "ID")+"&DicName="+ DataBinder.Eval(Container.DataItem, "DicName")%>'><%# DataBinder.Eval(Container.DataItem, "DicName")%></asp:HyperLink>
                                </ItemTemplate>
