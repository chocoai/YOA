    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;公文收发&nbsp;>>&nbsp;传阅文件归档浏览
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="文件夹名称"> <ItemTemplate> <img src="../images/filetype/dir.gif" /> <asp:HyperLink ID="HyperLink1" runat="server"   NavigateUrl='<%# "SendFile.aspx?DicID="+ DataBinder.Eval(Container.DataItem, "ID")+"&DicName="+ DataBinder.Eval(Container.DataItem, "DicName")%>'><%# DataBinder.Eval(Container.DataItem, "DicName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
