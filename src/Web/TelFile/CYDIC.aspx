                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="文件夹名称">
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "CYDICView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "DicName")%></asp:HyperLink>
                                </ItemTemplate>
