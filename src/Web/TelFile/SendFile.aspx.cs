...
public partial class TelFile_SendFile : System.Web.UI.Page
{
    ...
    public void DataBindToGridview()
    {
        ...
        GVData.DataSource = MyERPTelFile.GetList("TitleStr like '%" + this.TextBox1.Text.Trim() + "%' and FromUser='" + ZWL.Common.PublicMethod.GetSessionValue("UserName") + "' and " + GetDicNameCondition() + " order by ID desc");
        GVData.DataBind();
