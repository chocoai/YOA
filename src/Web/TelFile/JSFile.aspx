<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JSFile.aspx.cs" Inherits="TelFile_JSFile" %>
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="文件夹名称">
                                <ItemTemplate>
                                    ...
                                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "GetFile.aspx?DicID="+ DataBinder.Eval(Container.DataItem, "ID")+"&DicName="+ DataBinder.Eval(Container.DataItem, "DicName")%>'><%# DataBinder.Eval(Container.DataItem, "DicName")%></asp:HyperLink>
                                </ItemTemplate>
