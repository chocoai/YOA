<%@ page language="C#" autoeventwireup="true" inherits="Supply_BuyOrder, App_Web_qtgru7wp" %>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;供应商管理&nbsp;>>&nbsp;订单管理
                </td>
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    ...
                    <asp:ImageButton id="ImageButton1" onclick="ImageButton1_Click" runat="server" ImageUrl="../images/Button/ShenPiOK.jpg" ImageAlign="AbsMiddle" OnClientClick="javascript:return CheckDel1();"></asp:ImageButton>&nbsp;<asp:ImageButton id="ImageButton5" onclick="ImageButton5_Click" runat="server" ImageUrl="../images/Button/ShenPiNo.jpg" ImageAlign="AbsMiddle" OnClientClick="javascript:return CheckDel();"></asp:ImageButton>
                        ...
                        <asp:TemplateField HeaderText="订单名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "BuyOrderView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "OrderName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>                       
                         <asp:BoundField DataField="Serils" HeaderText="订单编码" >
                        </asp:BoundField>                             
                        <asp:BoundField DataField="DingDanLeiXing" HeaderText="订单类型" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="GongYingShangName" HeaderText="供应商" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="ChuangJianRen" HeaderText="创建人" >
                        </asp:BoundField>      
                        <asp:BoundField DataField="CreateDate" HeaderText="创建时间" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="NowState" HeaderText="当前状态" >
                        </asp:BoundField>             
                    </Columns>
