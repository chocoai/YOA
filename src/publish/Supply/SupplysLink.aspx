<%@ page language="C#" autoeventwireup="true" inherits="Supply_SupplysLink, App_Web_qtgru7wp" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <td align="right" valign="middle" style="border-bottom: #006633 1px dashed; height: 30px;">
                    供应商名称：<asp:TextBox ID="TextBox1" runat="server" Height="20px" Width="60px"></asp:TextBox><asp:ImageButton
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="IFFirstLink" HeaderText="主联系人" >
                        </asp:BoundField>  
