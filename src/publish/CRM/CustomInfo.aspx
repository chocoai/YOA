<%@ page language="C#" autoeventwireup="true" inherits="CRM_CustomInfo, App_Web_xz6d1gc2" %>
<html>
	<head>
             ...
             <td colspan="2" style="border-bottom: #006633 1px dashed; height: 30px" valign="middle">
                 &nbsp; &nbsp;&nbsp;
                    选择过滤条件：<asp:DropDownList ID="DropDownList1" runat="server">
                        ...
                        <asp:ListItem Value="BackInfoA">5S管理</asp:ListItem>
            ...
            <td style="border-top: #000000 1px solid;border-bottom: #000000 1px solid">
                ...
                &nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; 目的业务员：<asp:TextBox ID="TextBox4" runat="server"
                    Height="20px" Width="71px"></asp:TextBox><img
                     class="HerCss" onclick="var wName;var RadNum=Math.random();wName=window.showModalDialog('../Main/SelectUser.aspx?TableName=ERPUser&LieName=UserName&Radstr='+RadNum,'','dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');if(wName==null){}else{document.getElementById('TextBox4').value=wName;}"
                     src="../images/Button/search.gif" />
