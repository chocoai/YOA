<%@ page language="C#" autoeventwireup="true" inherits="Sell_Contract, App_Web_cnb8ueog" %>
                        ...
                        <asp:TemplateField HeaderText="合同名称">
                            <ItemTemplate>                                
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "ContractView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "HeTongName")%></asp:HyperLink>
                            </ItemTemplate>                            
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>                       
                         <asp:BoundField DataField="HeTongSerils" HeaderText="合同编码" >
                        </asp:BoundField>                             
                        <asp:BoundField DataField="HeTongLeiXing" HeaderText="合同类别" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="QianYueKeHu" HeaderText="签约客户" >
                        </asp:BoundField>  
                        <asp:BoundField DataField="CreateUser" HeaderText="录入人" >
                        </asp:BoundField>      
