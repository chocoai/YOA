<%@ page language="C#" autoeventwireup="true" inherits="Main, App_Web_fibi_oai" %>
<HTML>
	<HEAD>
	...
	<body scroll="no" onload="setInterval(nowtime,1000)">
		<form id="main" method="post" runat="server">
			<table width="100%" height="100%" cellspacing="0" cellpadding="0" border="0">
				<tr>
					<td height="50" background="../images/TitleBg.gif" width="52%"><img src="../images/product.png" /></td>
...
document.write(
     ...
     d[today.getDay()+1],
     "" ); 
</script>&nbsp;<img align="absMiddle" src="../images/time.gif" />
<span id="t1"><script language="javascript">todaytime1=new Date();t1.innerText=todaytime1.getHours()+'：'+todaytime1.getMinutes()+'：'+todaytime1.getSeconds();</script></span>
&nbsp;&nbsp;
<script language="javascript">
function nowtime()
{
						...
						<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" >
							<tr>
								<td width="185" height="100%" valign="top" class="" id="td1">
									...
									<tr ><td width="185" bgcolor="#D4E4F1" height="100%" style=" padding-bottom:5px;">
									
									<table width="185" height="100%"  border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td height="28" background="../images/Tree_01.jpg">&nbsp;&nbsp;&nbsp;&nbsp;<span style="color: #ffffff">导航&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="hei" target="rform" href="OnlineUser.aspx">组织</a>&nbsp;&nbsp;<a class="hei" target="rform" href="../Mobile/MobileSms.aspx">短信</a>&nbsp;&nbsp;<a class="hei" target="rform" href="../LanEmail/LanEmailShou.aspx">邮件</a></span></td>
	</tr>	
	<tr>
		<td background="../images/Tree_03.jpg" style=" padding-bottom:3px; padding-top:5px; padding-left:10px;padding-right:10px;"><div style="OVERFLOW:auto;HEIGHT:100%;SCROLLBAR-FACE-COLOR:#ffffff;SCROLLBAR-HIGHLIGHT-COLOR:#6fa4d0;SCROLLBAR-SHADOW-COLOR:#6fa4d0;SCROLLBAR-3DLIGHT-COLOR:#e6e6e6;SCROLLBAR-ARROW-COLOR:#6fa4d0;SCROLLBAR-TRACK-COLOR:#ffffff;SCROLLBAR-DARKSHADOW-COLOR:#e6e6e6;">
