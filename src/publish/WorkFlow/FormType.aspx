<%@ page language="C#" autoeventwireup="true" inherits="WorkFlow_FormType, App_Web_by5tafno" %>
<html>
	<head>
    ...
    <div>    
     <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;工作流程&nbsp;>>&nbsp;表单类型
                </td>
        ...
        <tr>
            <td align="right" style="width: 170px; background-color: #cccccc; height: 25px;" >
                ...
                <td style="background-color: #ffffff; height: 25px; padding-left:5px;" >
                    <asp:TextBox ID="TextBox1" runat="server" CssClass="inputCss" Width="448px" Height="92px" TextMode="MultiLine"></asp:TextBox>
