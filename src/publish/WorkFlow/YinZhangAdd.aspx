<%@ page language="C#" autoeventwireup="true" inherits="WorkFlow_YinZhangAdd, App_Web_by5tafno" %>
<html>
	<head>
    ...
    <div>    
     <table id="PrintHide" style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;工作流程&nbsp;>>&nbsp;添加<%=Request.QueryString["Type"].ToString() %>
                </td>
