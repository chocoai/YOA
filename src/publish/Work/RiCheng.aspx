<%@ page language="C#" autoeventwireup="true" inherits="Work_RiCheng, App_Web_skki5bxu" %>
<html>
	<head>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
        ...
        <tr>
            <td style="border-top: #000000 1px solid;border-bottom: #000000 1px solid">
                ...
                <img align="absMiddle" src="../images/TreeImages/test.gif" /><asp:HyperLink ID="HyperLink2"
                    runat="server" Font-Bold="True" Font-Underline="True" ForeColor="Red" NavigateUrl="~/Work/ManageRiCheng.aspx?Type=Share">查看共享业务数据</asp:HyperLink>
                &nbsp; &nbsp;
                <img align="absMiddle" src="../images/TreeImages/test.gif" /><asp:LinkButton ID="LinkButton2"
                    runat="server" Font-Bold="True" ForeColor="Red" OnClientClick="javascript:return CheckModify1();" OnClick="LinkButton2_Click">添加到联系记录</asp:LinkButton></td>
        </tr>
        </table>
        </asp:Panel>
        ...
        <asp:Calendar ID="Calendar1" runat="server" BackColor="White" BorderColor="Black"
            ...
            <img align="absMiddle" src="../images/TreeImages/test.gif" /><asp:HyperLink ID="HyperLink3"
                runat="server" Font-Bold="True" Font-Underline="True" ForeColor="Red" NavigateUrl="~/Work/ManageRiCheng.aspx?Type=Share">查看共享业务数据</asp:HyperLink></asp:Panel>
    </form>
</body>
</html>