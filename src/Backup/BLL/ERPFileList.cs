...
namespace ZWL.BLL
{
    ...
    public class ERPFileList
    {
        ...
        public int Add()
        {
            ...
            strSql.Append("FileName,BianHao,BackInfo,DaXiao,FileType,DirID,ShangChuanTime,FilePath,UserName,IFDel,TypeName,IfShare,DirOrFile)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete ERPFileList ");
            strSql.Append(" where ID=" + ID + " ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)				};
            parameters[0].Value = ID;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ID,FileName,BianHao,BackInfo,DaXiao,FileType,DirID,ShangChuanTime,FilePath,UserName,IFDel,TypeName,IfShare,DirOrFile ");
