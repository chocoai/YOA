...
namespace ZWL.BLL
{
	...
	public class ERPCarInfo
	{
		...
		public ERPCarInfo(int ID)
		{
			...
			strSql.Append("select ID,CarName,CarPaiHao,CarXingHao,LeiXing,DriverUser,NowState,UserName,TimeStr,BackInfo ");
		...
		public int Add()
		{
			...
			strSql.Append("CarName,CarPaiHao,CarXingHao,LeiXing,DriverUser,NowState,UserName,TimeStr,BackInfo)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ID,CarName,CarPaiHao,CarXingHao,LeiXing,DriverUser,NowState,UserName,TimeStr,BackInfo ");
			strSql.Append(" FROM ERPCarInfo ");
			strSql.Append(" where ID=@ID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
